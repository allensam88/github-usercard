...
//Iterate thru new profiles with newResponse to create new cards.
const followersArray = ['allensam88', 'nadeemanvaritafti', 'tetondan', 'dustinmyers', 'justsml', 'luishrd', 'bigknell'];
